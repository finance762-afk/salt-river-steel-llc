...
<section class="section sp-gallery" aria-label="Recent commercial steel work by Salt River Steel">
    <div class="container">
        <div class="section-title reveal-up">
            <span class="eyebrow-label">Recent Work</span>
            <h2>Commercial steel we've <span class="text-accent">built recently</span></h2>
        </div>
        <div class="sp-gallery-grid" data-p1-dynamic>
            <figure class="sp-gallery-item reveal-up reveal-delay-1">
                <img src="/assets/images/steel-shop-interior-roll-up-doors-960.webp" srcset="/assets/images/steel-shop-interior-roll-up-doors-480.webp 480w, /assets/images/steel-shop-interior-roll-up-doors-960.webp 960w, /assets/images/steel-shop-interior-roll-up-doors-1440.webp 1440w" sizes="(max-width: 900px) 100vw, 520px" alt="Interior of a finished steel shop with roll-up doors built by Salt River Steel" width="960" height="720" loading="lazy" decoding="async">
                <figcaption>Finished shop interior with roll-up doors</figcaption>
            </figure>
            <figure class="sp-gallery-item reveal-up reveal-delay-2">
                <img src="/assets/images/clear-span-steel-building-interior-960.webp" srcset="/assets/images/clear-span-steel-building-interior-480.webp 480w, /assets/images/clear-span-steel-building-interior-960.webp 960w, /assets/images/clear-span-steel-building-interior-1440.webp 1440w" sizes="(max-width: 900px) 100vw, 380px" alt="Clear-span red-iron steel building interior built by Salt River Steel" width="960" height="720" loading="lazy" decoding="async">
                <figcaption>Clear-span red-iron building</figcaption>
            </figure>
            <figure class="sp-gallery-item reveal-up reveal-delay-3">
                <img src="/assets/images/steel-crash-barrier-sports-facility-960.webp" srcset="/assets/images/steel-crash-barrier-sports-facility-480.webp 480w, /assets/images/steel-crash-barrier-sports-facility-960.webp 960w, /assets/images/steel-crash-barrier-sports-facility-1440.webp 1440w" sizes="(max-width: 900px) 100vw, 380px" alt="Yellow steel crash barrier fabricated and installed by Salt River Steel at a sports facility" width="960" height="720" loading="lazy" decoding="async">
                <figcaption>Steel crash barrier, sports facility</figcaption>
            </figure>
        </div>
    </div>
</section>
