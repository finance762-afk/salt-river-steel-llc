...
<body>
    ...
    <!-- Mobile Menu Overlay — OUTSIDE the header: the header's backdrop-filter would otherwise
         become the containing block for this fixed element and shrink it to the bar height. -->
    <!-- Mobile Menu Overlay -->
