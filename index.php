...
$heroPreloadImage = '';                         // hero is a discoverable <img fetchpriority="high"> — no separate preload needed

/* ---------- Homepage FAQs (from research_brief + one local/service item; all factual) ---------- */
$faqs = [
    [
        'question' => 'How quickly can Salt River Steel deliver orders to local projects?',
        'answer'   => 'Most custom orders ship within 3–5 business days from our Florence facility — significantly faster than out-of-state suppliers. We keep common stock items on hand for rush jobs.',
    ],
    [
    ...
    [
        ...
        'answer'   => 'Absolutely. As a local Florence operation, we work directly with your team to prioritize rush jobs. Call (480) 450-6959 for expedited fabrication options and pricing.',
    ],
    [
...
/* ---------- Service card image + icon mapping (canonical slug-matched photos on disk) ---------- */
$serviceMedia = [
    ...
    'residential-steel-work'        => ['img' => 'residential-steel-work',        'icon' => 'home',         'alt' => 'Residential steel-sided building addition in Central Arizona',                       'bullets' => ['Railings, stairs & carports', 'Metal-clad additions', 'Architectural metalwork']],
...
/* ============================================================
   ...
   Tokens only for brand values; rgba white/black reserved for
   glass/overlay treatments (matches framework convention).
   ============================================================ */
...
:root {
  ...
  --color-card-tint-3: rgba(6, 182, 212, 0.10);           /* accent @ 10% */
  --hp-line: rgba(var(--color-primary-rgb), 0.10);
}

/* ============================================================
   HERO — layered, 60/40 split with lead-capture card
   ============================================================ */
.hero-modern {
  position: relative;
  min-height: 100vh;
...
/* ============================================================
   SECTION DIVIDERS (two distinct styles) + numbered sections
   ============================================================ */
.divider-slant { position: relative; height: 0; }
...
/* ============================================================
   SERVICES — tinted image cards (required-components pattern)
   ============================================================ */
...
.cta-band::before {
  ...
  background: radial-gradient(circle at 20% 30%, rgba(6,182,212,0.35), transparent 45%),
...
/* ============================================================
   ABOUT / PROCESS — asymmetric split
   ============================================================ */
...
/* ============================================================
   WHY-US (dark) — proof without fabricated reviews
   ============================================================ */
...
.whyus-card:hover { transform: translateY(-5px); border-color: rgba(6,182,212,0.5); }
.whyus-card__icon { width: 48px; height: 48px; border-radius: var(--radius-md); background: rgba(6,182,212,0.16); color: var(--color-accent); display: flex; align-items: center; justify-content: center; margin-bottom: var(--space-4); }
...
.closing-cta::after {
  ...
  border-radius: 50%; background: rgba(6,182,212,0.18); pointer-events: none;
}
...
/* ============================================================
   SCROLL REVEALS — fail-open, gated under html.js-anim
   ============================================================ */
...
/* ============================================================
   HERO RESPONSIVE — stack, card below text
   ============================================================ */
...
<div class="ticker-strip" aria-hidden="true">
    <div class="ticker-track">
        ...
        $tickerItems = [
            ...
            ['calendar', 'Serving Central AZ Since 2022'],
        ];
                ...
                <div class="process-steps">
                    <div class="process-step reveal-up reveal-delay-1">
                        ...
                        <div class="process-step__body">
                            <h3><?php echo icon('ruler', 20); ?> Consult &amp; Measure</h3>
                            <p>We review your plans on-site or by phone, confirm dimensions, and recommend the right grade for the job and the climate.</p>
                        </div>
                    </div>
                    <div class="process-step reveal-up reveal-delay-2">
                        <div class="process-step__num">2</div>
                        <div class="process-step__body">
                            <h3><?php echo icon('pen-tool', 20); ?> Design &amp; Quote</h3>
                            <p>You get a clear, itemized quote and a realistic turnaround before any steel is cut — no surprises.</p>
                        </div>
                    </div>
                    <div class="process-step reveal-up reveal-delay-3">
                        <div class="process-step__num">3</div>
                        <div class="process-step__body">
                            <h3><?php echo icon('hammer', 20); ?> Fabricate In-House</h3>
                            <p>Our Florence team handles specialized cuts, welding, and finishing — most custom orders ready in 3–5 business days.</p>
                        </div>
                    </div>
                    <div class="process-step reveal-up reveal-delay-4">
                        <div class="process-step__num">4</div>
                        <div class="process-step__body">
                            <h3><?php echo icon('truck', 20); ?> Deliver or Install</h3>
                            <p>We deliver to your Central Arizona job site or set it for pickup — and coordinate install where the project calls for it.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="whyus-grid">
            ...
            $whyCards = [
                ...
                ['users',        'Direct, Straight Answers',     'Property owners and contractors work directly with the crew doing the work, cutting the procurement complexity out of the middle.'],
